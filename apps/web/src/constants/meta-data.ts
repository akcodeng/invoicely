...
export const defaultWebsiteMetadata: Metadata = {
  ...
  description:
    "Invoicely is a simple and easy to use invoice generator where you can create beautiful and professional invoices in minutes. Built by Imoogle Technology. Proudly OSS.",
  icons: {
